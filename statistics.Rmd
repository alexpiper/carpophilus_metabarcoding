...
These inputs were generated during the bioinformatic analysis
...
# Get expected and observed taxa
...
fits_all <- readRDS("output/fits_all.rds")
...
Can bias be explained by the number of mismatching bases to the primers?
