...
ps <- readRDS("../silverman/dada2_gut/phyloseq.rds")

# load added metadata
path.addedmeta <- "../silverman/gut_updated_metadata/2017.08.14MappingFile_addedmetadata.txt"
...
p <- bias %>% 
  ...
  geom_label(aes(label=rank2), size=3) +
  theme_minimal() +
