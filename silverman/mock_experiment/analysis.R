...
setwd("C:/Users/ap0y/Dropbox/workprojects/PHD/Metabarcoding/carpophilus_metabarcoding/silverman")

# Load Data ---------------------------------------------------------------

# Read in picogreen results 
pg <- read_csv("../silverman/qpcr_mock/PCRBias_PicogreenPoolConc.csv")
qpcr <- readxl::read_xlsx("../silverman/qpcr_mock/PCRBias.xlsx")
...
# read in phyloseq
ps <- readRDS("../silverman/dada2_mock/phyloseq.rds")
